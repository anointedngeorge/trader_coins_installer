...
const wizardSteps = [
  {
    ...
    meta: {
      ...
      subtitle:
        'Choose the exchange platform you want to use (KuCoin or Binance)',
    },
  },
  {
    ...
    meta: {
      ...
      subtitle: 'Add the license for the exchange platform you want to use',
    },
  },
  {
    ...
    meta: {
      ...
      subtitle: 'Add the credentials for the exchange platform you want to use',
    },
  },
  {
  ...
  },
  {
    ...
    meta: {
      ...
      subtitle: 'Finish the wizard of the exchange platform you want to use',
    },
  },
]
