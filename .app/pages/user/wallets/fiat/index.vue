          ...
          <BaseCard class="overflow-hidden p-6 col-span-12 lg:col-span-8">
            <div class="mb-12 flex items-center justify-between">
              ...
              <div class="flex gap-2 xs:flex-col sm:flex-row">
                <BaseButton
                  ...
                  color="success"
                  shadow="hover"
                  :to="`/user/wallets/fiat/deposit/${activeWallet?.uuid}`"
                >
                  {{ $t('Deposit') }}
                </BaseButton>
                <BaseButton
                  ...
                  color="danger"
                  shadow="hover"
                  :to="`/user/wallets/fiat/withdraw/${activeWallet?.uuid}`"
                >
                  {{ $t('Withdraw') }}
                </BaseButton>
              </div>
            ...
            <div class="mt-4 flex justify-center text-center">
              ...
              >
                {{
                  $t(
                    'Monitor your income, expenses, and transactions conveniently in one place',
                  )
                }}.
              </p>
            </div>
