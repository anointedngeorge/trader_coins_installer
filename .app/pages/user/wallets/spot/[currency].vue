    ...
    <TairoContentWrapper>
      ...
      >
        <div class="my-auto text-center flex-col justify-center space-y-5">
          ...
          <BaseButtonAction to="/user/wallets/spot">
          ...
          <BaseCard class="overflow-hidden p-6 col-span-12 lg:col-span-7">
            ...
            >
              <BaseButton
                ...
                color="success"
                shadow="hover"
                :to="`/user/wallets/spot/deposit/${wallet?.currency.toLowerCase()}`"
              >
                <Icon
              ...
              <BaseButton
                ...
                color="danger"
                shadow="hover"
                :to="`/user/wallets/spot/withdraw/${wallet?.currency.toLowerCase()}`"
              >
                <Icon
              ...
              <BaseButton
                ...
                color="warning"
                shadow="hover"
                :to="`/user/wallets/spot/transfer/${wallet?.currency.toLowerCase()}`"
              >
                <Icon
                  name="solar:card-send-bold-duotone"
                  class="h-6 w-6 mr-2"
