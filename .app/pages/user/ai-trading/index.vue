...
import aiJson from '~~/assets/lottie/ai.json'
import blockchain3Json from '~~/assets/lottie/blockchain3.json'
definePageMeta({
  title: 'AI Trading Assistant',
})
const aiTradingInvestmentStore = useAiTradingInvestmentStore()
const investments = computed(() => aiTradingInvestmentStore.investments)
    ...
    <TairoContentWrapper>
      ...
      >
        ...
        >
          <client-only>
            <Vue3Lottie
              class="pointer-events-none absolute -top-6 start-3 sm:-start-5 sm:-top-12"
      ...
      <template v-if="investments.length === 0">
        ...
        >
          <div class="mx-auto w-full flex items-center text-center relative">
            ...
            <client-only v-if="$viewport.isGreaterThan('sm')">
              <Vue3Lottie :animationData="blockchain3Json" height="400px" />
            </client-only>
          </div>
        </div>
      </template>
                    ...
                    >
                      {{
                        item.result === 'WIN'
                          ...
                          ? '-'
                          : ''
                      }}{{ item.profit }} {{ item.market.split('/')[1] }}
                    </span>
                    <span
