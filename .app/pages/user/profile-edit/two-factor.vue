...
const changeTwoFaMode = ref(user.value?.twofactor?.type ? false : true)
          ...
          <div>
            <div class="w-full">
              <div class="mx-auto w-full">
                <div class="w-full">
                  <div
                    class="mx-auto mb-8 grid gap-6 xs:grid-cols-1 md:grid-cols-2"
                    :class="{
                  ...
                  >
                    ...
                    <UserProfileTwoFactorOTPMethodRadio
                      v-if="user?.twofactor?.type !== 'SMS' || !user?.twofactor"
                      :modelValue="twoFaMode"
                      @update:modelValue="(val) => (twoFaMode = val)"
                      name="radio_custom"
                      value="SMS"
