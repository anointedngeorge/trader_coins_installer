...
import faqJson from '~~/assets/lottie/faq.json'
...
<template>
  ...
  >
    ...
    >
      <client-only>
        <Vue3Lottie :animationData="faqJson" />
      </client-only>
            ...
            <template v-for="(faq, index) in faqs">
              <h2 :id="`accordion-flush-heading-${index}`">
                <button
                  ...
                  class="flex justify-between items-center py-5 w-full font-medium text-left bg-white border-b border-gray-200 dark:border-gray-700 dark:bg-gray-900 px-2"
