...
import courseJson from '~~/assets/lottie/course.json'
import securityJson from '~~/assets/lottie/security.json'
...
<template>
  ...
  >
    ...
    >
      <client-only>
        <Vue3Lottie
          :animationData="user?.twofactor?.enabled ? courseJson : securityJson"
          class="pointer-events-none absolute -top-6 start-3 sm:-start-5 sm:-top-10"
          height="300px"
        />
      </client-only>
    </div>
