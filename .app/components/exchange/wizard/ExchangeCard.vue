...
<template>
  <div
    class="relative dark:hover:bg-muted-800 hover:shadow-muted-300/30 dark:hover:shadow-muted-800/30 group rounded-2xl transition-all duration-300 hover:bg-white hover:shadow-xl pb-20 pt-5"
    :class="[
